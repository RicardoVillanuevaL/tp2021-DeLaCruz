...
class VerificarLlegadaPage extends StatefulWidget {
  ...
  final int id;
  VerificarLlegadaPage({Key? key, required this.idEvento, required this.id }) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(12.0),
                child: Text(
                    'Registre una foto y escriba un comentario (opcional): ',
                    style: TextStyle(
                      color: colorBlueDark2,
                      fontSize: 18,
                    )),
                      ...
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 12),
                          ...
                          child: TextButton.icon(
                            onPressed: () {
                             if (existeFoto) {
                               ...
                               ScaffoldMessenger.of(context)
                                ...
                                Navigator.push(context, CupertinoPageRoute(builder: (BuildContext context)  => ListaEquiposEvento(id: id,) ) );
                             }
                            },
                            icon: FaIcon(
                            ...
                            label: Text('Registrar Llegada',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                          )),
            ],
          ),
        ),
